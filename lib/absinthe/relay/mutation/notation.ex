defmodule Absinthe.Relay.Mutation.Notation do
  @moduledoc """
  Common schema notation macros for mutations. This module should never be
  directly imported; instead, `use` `Absinthe.Relay.Schema` or
  `Absinthe.Relay.Schema.Notation`. See those modules for more information.

  Specific support for Relay Classic/Modern can be found in:
  - `Absinthe.Relay.Mutation.Notation.Classic`
